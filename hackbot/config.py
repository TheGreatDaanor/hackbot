...
TOOL_INSTALL_MAP: Dict[str, Dict[str, object]] = {
    ...
    "wfuzz": {
        ...
        "pip": "wfuzz",
        "apt": "wfuzz",
        # wfuzz requires setuptools (pkg_resources) on Python 3.12+;
        # the pre_install hook ensures it's present before wfuzz.
        "pre_install": ["pip install setuptools"],
    },
    "dnsenum": {"order": ["apt"], "apt": "dnsenum"},
    "dirb": {"order": ["apt"], "apt": "dirb"},
    "searchsploit": {"order": ["apt"], "apt": "exploitdb"},
    "msfconsole": {"order": ["apt"], "apt": "metasploit-framework"},
    "msfvenom": {"order": ["apt"], "apt": "metasploit-framework"},
    "john": {"order": ["apt"], "apt": "john"},
    "hashcat": {"order": ["apt"], "apt": "hashcat"},
    "wifite": {"order": ["apt"], "apt": "wifite"},
    "aircrack-ng": {"order": ["apt"], "apt": "aircrack-ng"},
    "airodump-ng": {"order": ["apt"], "apt": "aircrack-ng"},
    "aireplay-ng": {"order": ["apt"], "apt": "aircrack-ng"},
    "airbase-ng": {"order": ["apt"], "apt": "aircrack-ng"},
    "reaver": {"order": ["apt"], "apt": "reaver"},
    "wash": {"order": ["apt"], "apt": "reaver"},
    "hcxdumptool": {"order": ["apt"], "apt": "hcxdumptool"},
    "hcxpcapngtool": {"order": ["apt"], "apt": "hcxtools"},
    ...
    "snmpwalk": {"order": ["apt"], "apt": "snmp"},
    "tcpdump": {"order": ["apt"], "apt": "tcpdump"},
    "tshark": {"order": ["apt"], "apt": "tshark"},
    "whois": {"order": ["apt"], "apt": "whois"},
    "fping": {"order": ["apt"], "apt": "fping"},
    "arp-scan": {"order": ["apt"], "apt": "arp-scan"},
    "netdiscover": {"order": ["apt"], "apt": "netdiscover"},
    "netcat": {"order": ["apt"], "apt": "netcat-traditional"},
    "testssl": {"order": ["apt"], "apt": "testssl.sh"},
    "sslscan": {"order": ["apt"], "apt": "sslscan"},
    "thc-ipv6": {"order": ["apt"], "apt": "thc-ipv6"},
    "commix": {"order": ["apt"], "apt": "commix"},
    "dalfox": {"order": ["go"], "go": "github.com/hahwul/dalfox/v2@latest"},
